...
namespace titanium {
	namespace bindings {
		...
		class AudioselectorBindings {
			public:
				static BindEntry* lookupGeneratedInit(const char*, unsigned int);
		};

		BindEntry* AudioselectorBindings::lookupGeneratedInit(const char* name, unsigned int length) {
			static BindEntry binds[] = {
				{"de.appwerft.audioselector.AudioselectorModule", ::de::appwerft::audioselector::AudioselectorModule::bindProxy, ::de::appwerft::audioselector::AudioselectorModule::dispose}
			};
