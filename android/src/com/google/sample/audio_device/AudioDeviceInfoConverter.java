...
public class AudioDeviceInfoConverter {
	...
	/**
	 * Converts an {@link AudioDeviceInfo} object into a human readable
	 * representation
	 *
	 * @param adi
	 *            The AudioDeviceInfo object to be converted to a String
	...
	/**
	 * Converts an integer array into a string where each int is separated by a
	 * space
	 *
	 * @param integerArray
	 *            the integer array to convert to a string
	 ...
	 * 
	 * @param type
	 *            One of the {@link AudioDeviceInfo}.TYPE_* values e.g.
	 *            AudioDeviceInfo.TYPE_BUILT_IN_SPEAKER
